...
| --- | --- | --- |
| [parallel-browser-mcp](https://github.com/etairl/parallel-browser-mcp) | MCP server for parallel browser automation by AI agents across multiple cloud providers | 99 |
| [OpenIoT](https://github.com/etairl/OpenIoT) | Open-source IoT platform for makers | 31 |
| [Probus](https://github.com/etairl/Probus) | Open-source AI vulnerability discovery | 23 |
